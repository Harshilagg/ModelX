                        ...
                        children: [
                          GridView.count(
                            ...
                            children: [
                              ...
                              DashboardCard(
                                ...
                                value: castings.length.toString(),
                                icon: Icons.history,
                              ),
                            ],
                          ),
                          ...
                          if (!modelsSnap.hasData)
                            ...
                            const EmptyState(
                              ...
                              title: 'No models yet',
                              message:
                                  'Models added to your roster will show up here.',
                            )
                          else
                            SizedBox(
                              height: 140,
                          ...
                          if (!castingsSnap.hasData)
                            ...
                            const EmptyState(
                              ...
                              message: 'Castings you post will show up here.',
                            )
                          else
                            Column(
