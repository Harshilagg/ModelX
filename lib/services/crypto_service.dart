...
class CryptoService {
  ...
  static Future<String> encryptFor(
    String receiverPubBase64,
    String content,
  ) async {
    final algorithm = X25519();
    ...
    final derived = await hkdf.deriveKey(
      ...
      info: utf8.encode('modelx chat key'),
    );
